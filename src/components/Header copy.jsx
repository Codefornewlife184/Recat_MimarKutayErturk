...
export default function Header() {
  ...
  const searchItems = useMemo(() => ([
    { title: t.nav.home, path: localizePath('/'), keywords: `${t.nav.home} mimar kutay erturk home` },
    { title: t.nav.about, path: localizePath('/aboutus'), keywords: `${t.nav.about} architect mimar kutay erturk` },
    { title: t.nav.projects, path: localizePath('/services'), keywords: `${t.nav.projects} services portfolio design architecture` },
    { title: t.nav.projects, path: localizePath('/projects'), keywords: `${t.nav.projects} portfolio gallery detail` },
    { title: t.pageMeta.blog, path: localizePath('/blog'), keywords: `${t.pageMeta.blog} articles news journal` },
    { title: t.nav.beforeAfter, path: localizePath('/servicesafterbefore'), keywords: `${t.nav.beforeAfter} before after renovation` },
    { title: t.nav.contact, path: localizePath('/contact'), keywords: `${t.nav.contact} phone whatsapp email address` },
              ...
              <div className="header-left-wrap">
                ...
                <div className="header-menu-wrap">
                  <div className="mobile-menu-items">
                    <ul>
                      <li><Link to={localizePath('/')} onClick={scrollToTop}>{t.nav.home}</Link></li>
                      <li><Link to={localizePath('/aboutus')} onClick={scrollToTop}>{t.nav.about}</Link></li>
                      <li className="menu-item-has-children">
                        <Link to={localizePath('/projects')} onClick={scrollToTop}>{t.nav.projects}</Link>
                        <ul>
                          <li><Link to={localizePath('/projects')} onClick={scrollToTop}>{t.nav.allProjects}</Link></li>
                          {projectCategories.map((category) => (
                            <li key={category.slug}>
                              <Link to={localizePath(`/projects?category=${category.slug}`)} onClick={scrollToTop}>
                      ...
                      <li><Link to={localizePath('/contact')} onClick={scrollToTop}>{t.nav.contact}</Link></li>
...
*/}
              ...
              <div className="header-right-wrap">
                <a href="tel:+9005555572208" className="search-icon" aria-label="Telefon ile ara">
                  <span className="icon"><i className="fa-regular fa-phone" style={phoneIconStyle}></i></span>
                ...
                >
                  <span className="icons"><i className="fab fa-whatsapp" style={whatsappIconStyle}></i></span>
                  <span className="content">
                    <span className="call-number"></span>
                  </span>
                </a>
                <div className="language-switcher desktop-language-switcher">
                  {SUPPORTED_LOCALES
    .filter(languageCode => languageCode !== 'ar') // Arapçayı burada filtreliyoruz
    .map((languageCode) => (
                    <Link
                      key={languageCode}
                    ...
                    >
                      <span className="language-switcher-text">{languageCode.toUpperCase()}</span>
                    </Link>
                  ))}
                </div>
                ...
                <div className="sidebar-icon">
                  <button className="sidebar-trigger open">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M11 13C11 11.8954 11.8954 11 13 11H14C15.1046 11 16 11.8954 16 13V14C16 15.1046 15.1046 16 14 16H13C11 16 11 15.1046 11 14V13Z" fill="white"/>
                    </svg>
                  </button>
                </div>
              </div>
      ...
      <div id="popup-search-box">
        <div className="box-inner-wrap d-flex align-items-center">
          <form id="form" action="#" method="get" role="search" onSubmit={handleSearchSubmit}>
            <input
              id="popup-search"
              type="text"
              name="s"
      ...
      <div id="sidebar-area" className="sidebar-area">
        ...
        <div className="side-menu-content">
          <div className="side-menu-logo">
            <a className="dark-img" href={localizePath('/')}><img src="/assets/img/logo/logo-mke-beyaz.png" alt="logo" /></a>
            <a className="light-img" href={localizePath('/')}><img src="/assets/img/logo/logo-mke-siyah.png" alt="logo" /></a>
          </div>
          <div className="side-menu-wrap"></div>
          <div className="side-menu-about">
            <h4 className="title">Mimar Kutay Ertürk</h4>
            <h3 className="title" style={{ color: '#caa05c' }}>{t.nav.projects}</h3>
          </div>
          <div className="side-menu-gallary">
            <div className="side-menu-gallary-item">
              <Link to={localizePath('/projects')} onClick={() => { scrollToTop(); document.body.classList.remove('open-sidebar') }}>
                <img src="/assets/img/project/sidebar-gallary-1.png" alt="img" />
              </Link>
            </div>
            <div className="side-menu-gallary-item">
              <Link to={localizePath('/projects')} onClick={() => { scrollToTop(); document.body.classList.remove('open-sidebar') }}>
                <img src="/assets/img/project/sidebar-gallary-2.png" alt="img" />
              </Link>
            </div>
            <div className="side-menu-gallary-item">
              <Link to={localizePath('/projects')} onClick={() => { scrollToTop(); document.body.classList.remove('open-sidebar') }}>
                <img src="/assets/img/project/sidebar-gallary-3.png" alt="img" />
              </Link>
            </div>
            <div className="side-menu-gallary-item">
              <Link to={localizePath('/projects')} onClick={() => { scrollToTop(); document.body.classList.remove('open-sidebar') }}>
                <img src="/assets/img/project/sidebar-gallary-4.png" alt="img" />
              </Link>
            </div>
            <div className="side-menu-gallary-item">
              <Link to={localizePath('/projects')} onClick={() => { scrollToTop(); document.body.classList.remove('open-sidebar') }}>
                <img src="/assets/img/project/sidebar-gallary-5.png" alt="img" />
              </Link>
            </div>
            <div className="side-menu-gallary-item">
              <Link to={localizePath('/projects')} onClick={() => { scrollToTop(); document.body.classList.remove('open-sidebar') }}>
                <img src="/assets/img/project/sidebar-gallary-6.png" alt="img" />
              </Link>
            </div>
          </div>
          <div className="side-menu-contact">
            <ul className="side-menu-list">
              <li>Bademli<br/> BURSA <br/>TÜRKİYE</li>
              <li><a href="tel:+0555572208">+90(555) 557-22-08</a></li>
              <li><a className="" href="mailto:info@mimarkutayerturk.com">info@mimarkutayerturk.com</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="mobile-side-menu">
        <div className="side-menu-content">
          <div className="side-menu-head">
            <a href={localizePath('/')}><img src="/assets/img/logo/logo-2.png" alt="logo" /></a>
          ...
          <div className="side-menu-contact">
            ...
            <ul className="side-menu-list">
              <li><i className="fas fa-map-marker-alt"></i><p>Bademli, Bursa, Türkiye</p></li>
              <li><i className="fas fa-phone"></i><a href="tel:+905555572208">+90 (555) 557-22-08</a></li>
              <li><i className="fas fa-envelope-open-text"></i><a href="mailto:info@mimarkutayerturk.com">info@mimarkutayerturk.com</a></li>
            </ul>
          </div>
